...
There are two ways the estimate of SNR is done:
    ...
    A.  By estimating the SNR from the envelope of the first transient of the TRACT experiment, and using the expected linewidh and the number of resonances to compute the expected intensity for a single peak.
...
The algorithm works as follows:
    ...
    1.  The provided spectrum is phased and the first transient is integrated.
